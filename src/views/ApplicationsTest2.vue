      ...
      <v-container class="spacing-playground py-0 px-2" fluid>
        <v-row>
          <v-col cols="12" class="d-flex align-center justify-end">
            <v-btn class="mr-4" depressed @click="validate">Две одинаково</v-btn>
          </v-col>
        </v-row>
        <v-row>
        ...
        <v-row>
          <v-col cols="12" class="d-flex align-center justify-end">
            <v-btn color="primary" depressed class="mr-4" @click="reset">Да</v-btn>
          </v-col>
        </v-row>
        <v-row>
          <v-col cols="12" class="d-flex align-center justify-end">
            <v-btn color="error" depressed class="mr-4" @click="reset">Нет</v-btn>
          </v-col>
        </v-row>
        <v-row>
          <v-col cols="12" class="d-flex align-center justify-end">
            <v-btn click="resetValidation" depressed class="mr-4">Я не знаю</v-btn>
          </v-col>
        </v-row>
        <v-row>
          <v-col cols="12" class="d-flex align-center justify-end">
